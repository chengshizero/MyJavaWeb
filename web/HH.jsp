...
<html>
    <head>
        <title>A、B pageTest</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
    </head>
    <body>
	
        <h1>A、B pageTest請輸入資料：</h1>
        <form action="datas/PP.jsp" method="post">
            ...
            <p>身份證字號：<input type="text" name="idd"  placeholder="請輸入身份證字號" title="請輸入身份證字號" required="required" pattern="[A-Za-z][12]\d{8}" /></p>            
